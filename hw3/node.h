...
// pre: none
// post: the linked list of items is reversed; the last node is first, the first node is last, etc. head_ptr now points to
//        the head of the reversed list.

void remove_repetitions(node* head_ptr);
// pre: none
// post: all repetitions from this linked list have been deleted
